...
import type {
  Checkbox$Outbound as CreemCheckbox,
  CheckoutEntity$Outbound as CreemCheckoutEntity,
  CustomField$Outbound as CreemCustomField,
  CustomerEntity$Outbound as CreemCustomerEntity,
  FeatureEntity$Outbound as CreemFeatureEntity,
  Instance$Outbound as CreemLicenseInstanceEntity,
  LicenseEntity$Outbound as CreemLicenseEntity,
  OrderEntity$Outbound as CreemOrderEntity,
  ProductEntity$Outbound as CreemProductEntity,
  ProductFeatureEntity$Outbound as CreemProductFeatureEntity,
  SubscriptionEntity$Outbound as CreemSubscriptionEntity,
  SubscriptionItemEntity$Outbound as CreemSubscriptionItemEntity,
  Text$Outbound as CreemText,
  TransactionEntity$Outbound as CreemTransactionEntity,
...
export type Text = CreemText;

export type Checkbox = CreemCheckbox;

export type CustomField = CreemCustomField;

// ============================================================================
// Customer Entity
// ============================================================================

export type CustomerEntity = CreemCustomerEntity;

// ============================================================================
// Product Entity
// ============================================================================

export type FeatureEntity = CreemFeatureEntity;

export type ProductEntity = CreemProductEntity;

// ============================================================================
// Transaction Entity
// ============================================================================

export type TransactionEntity = CreemTransactionEntity;
...
export type LicenseInstanceEntity = CreemLicenseInstanceEntity;

export type LicenseEntity = CreemLicenseEntity;

export type ProductFeatureEntity = CreemProductFeatureEntity;

// ============================================================================
// Subscription Entities
// ============================================================================

export type SubscriptionItemEntity = CreemSubscriptionItemEntity;

export type SubscriptionStatus = CreemSubscriptionEntity["status"];

export type SubscriptionEntity = CreemSubscriptionEntity;

// ============================================================================
// Checkout Entity
// ============================================================================

export type CheckoutStatus = CreemCheckoutEntity["status"];

export type CheckoutEntity = CreemCheckoutEntity;
...
export interface NormalizedSubscriptionEntity
  ...
  /** Optional metadata included with subscription webhooks */
  metadata?: Metadata;
}
